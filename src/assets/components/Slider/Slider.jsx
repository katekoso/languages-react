			...
			{isLoading ? (
				...
				<div className={styles.container}>
					<div className={styles.slider}>
						<div className={styles.slider__learn}>
							За урок вы изучили слов: {learnedWordsCount}
						</div>
						<div className={styles.slider__main}>
							...
							<SwitchTransition mode="out-in">
								...
								>
									<Card
										english={words[selectedIndex].english}
										russian={words[selectedIndex].russian}
										transcription={words[selectedIndex].transcription}
										countWords={countWords}
										key={words[selectedIndex].id}
									/>
								</CSSTransition>
							</SwitchTransition>
							<SliderButton direction={"next"} moveSlide={showNext} />
						</div>
						<div className={styles.slider__count}>
